...
const Navbar = () => {
  ...
  return (
    <>
      <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white z-50 fixed top-0 left-0 right-0 ${ sticy?"sticky-navbar shadow-md bg-base-200 dark:bg-slate-600 dark:text-white duration-300 transition-all ease-in-out":""}`}>
        <div className="navbar">
          ...
          <div className="navbar-end space-x-3">
            ...
            <label className="px-3 py-1 border rounded-md flex items-center gap-2">
              <input type="text" className="grow bg-transparent dark:bg-slate-900 dark:text-white" placeholder="Search" />
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 16 16"
                fill="currentColor"
  ...
  /></svg>
            ...
            <div className="">
              <a className="bg-black text-white px-5 py-2 font-bold rounded-md hover:bg-slate-800 duration-300 cursor-pointer" onClick={()=>document.getElementById("my_modal_3").showModal()} >Login
              </a>
              <Login/>
            </div>
          </div>
